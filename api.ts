...
namespace NumProp {
    ...
    //% isKind
    export const numProperty = create();
}    
...
namespace NumArrayProp {
    ...
    //% isKind
    export const numArrayProperty = create();
}    
...
namespace BoolProp {
    ...
    //% isKind
    export const boolProperty = create();
}    
...
namespace BoolArrayProp {
    ...
    //% isKind
    export const boolArrayProperty = create();
}    
...
namespace StrProp {
    ...
    //% isKind
    export const strProperty = create();
}    
...
namespace StrArrayProp {
    ...
    //% isKind
    export const strArrayProperty = create();
}    
...
namespace SpriteProp {
    ...
    //% isKind
    export const spriteProperty = create();
}    
...
namespace SpriteArrayProp {
    ...
    //% isKind
    export const spriteArrayProperty = create();
}    
...
namespace ImageProp {
    ...
    //% isKind
    export const imageProperty = create();
}    
...
namespace ImageArrayProp {
    ...
    //% isKind
    export const imageArrayProperty = create();
}    
...
namespace LocProp {
    ...
    //% isKind
    export const locProperty = create();
}    
...
namespace LocArrayProp {
    ...
    //% isKind
    export const locArrayProperty = create();
}    
...
namespace AnyProp {
    ...
    //% isKind
    export const anyProperty = create();
}    
